		 ...
		 <br>
					...
					<div class="Clear">
					    ...
					    <div class="jetblue-table regDocTable" id="borderTable" style="width:92%;border-bottom:10px solid rgb(241, 245, 248);">
											 ...
											 <c:forEach items="${dhpQRCodeResponse.dhpPaxQRCodeResponseItems}" var="dhpQRCodeItem" varStatus="dhpItemStatus">	
												...
												<span style="position:relative;top:40%;">
													...
													<span class="dobTextSmall">${dhpQRCodeItem.paxOrdinal}</span>
						  					...
						  					<c:forEach items="${dhpQRCodeItem.dhpPaxQRCodeResponseItem}" var="dhpItem" varStatus="dhpStatus">	
						  						            <span class="paymentSummaryLabel colTow" style="width:40%;">
						  							         ${dhpItem. dataType}
												             ...
												             <span class="paymentSummaryValueNew colThree" style="width:40%;"><img src="images/Completecheck.png"/>
